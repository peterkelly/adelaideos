...
#define USE_LIBC          /* Version 2 */
#define USE_PROCESSES     /* Version 3 */
#define USE_PAGING        /* Version 4 */
#define USE_SYSCALLS      /* Version 5 */
#define USE_MALLOC        /* Version 6 */
#define USE_FILEDESC      /* Version 7 */
#define USE_UNIXPROC      /* Version 8 */
#define USE_ANSWERS
